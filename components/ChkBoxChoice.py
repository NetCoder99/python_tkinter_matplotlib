...
def getChkBoxChoice(parent):
    # Choice Label
    parent.choiceLabel = ctk.CTkLabel(parent,
                                    text="Choice")
    parent.choiceLabel.grid(row=3, column=0,
                          padx=20, pady=20,
                          sticky="ew")
    ...
    parent.choice1 = ctk.CTkCheckBox(parent, text="choice 1",
                                   ...
                                   onvalue="choice1",
                                   offvalue="c1")
    parent.choice1.grid(row=3, column=1, padx=20,
                      pady=20, sticky="ew")
    ...
    parent.choice2 = ctk.CTkCheckBox(parent, text="choice 2",
                                   ...
                                   onvalue="choice2",
                                   offvalue="c2")
    parent.choice2.grid(row=3, column=2, padx=20, pady=20,
                      sticky="ew")
